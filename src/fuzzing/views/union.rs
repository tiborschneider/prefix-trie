...
fn check_iter(
    ...
    let want = expected_union(&left_reference, &right_reference, left_root, right_root);
...
fn check_lpm(
    ...
    let empty_left = PrefixMap::new();
    let empty_right = PrefixMap::new();
    let entries = expected_union(&left_reference, &right_reference, left_root, right_root);
...
root_root!(
    union_root_root_iter,
    _union_root_root_iter,
    union_root_root_lpm,
    _union_root_root_lpm,
    check_iter,
    check_lpm
);
root_sub!(
    union_root_sub_iter,
    _union_root_sub_iter,
    union_root_sub_lpm,
    _union_root_sub_lpm,
    check_iter,
    check_lpm
...
root_root!(
    union_mut_root_root_iter,
    _union_mut_root_root_iter,
    union_mut_root_root_lpm,
    _union_mut_root_root_lpm,
    check_iter_mut,
    check_lpm_mut
);
root_sub!(
    union_mut_root_sub_iter,
    _union_mut_root_sub_iter,
    union_mut_root_sub_lpm,
    _union_mut_root_sub_lpm,
    check_iter_mut,
    check_lpm_mut
);
sub_root!(
    union_mut_sub_root_iter,
    _union_mut_sub_root_iter,
    union_mut_sub_root_lpm,
    _union_mut_sub_root_lpm,
    check_iter_mut,
    check_lpm_mut
);
sub_sub!(
    union_mut_sub_sub_iter,
    _union_mut_sub_sub_iter,
    union_mut_sub_sub_lpm,
    _union_mut_sub_sub_lpm,
    check_iter_mut,
    check_lpm_mut
);
