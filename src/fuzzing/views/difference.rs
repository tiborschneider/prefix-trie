...
fn check_iter(
    ...
    let want = expected_difference(&left_reference, &right_reference, left_root, right_root);
    let got = view_or_empty(&left_map, &empty_left, left_root)
        .difference(view_or_empty(&right_map, &empty_right, right_root))
        .into_iter()
...
fn check_lpm(
    ...
    let empty_left = PrefixMap::new();
    let empty_right = PrefixMap::new();
    let entries = expected_difference(&left_reference, &right_reference, left_root, right_root);
...
root_root!(
    difference_root_root_iter,
    _difference_root_root_iter,
    difference_root_root_lpm,
    _difference_root_root_lpm,
    check_iter,
    check_lpm
);
root_sub!(
    difference_root_sub_iter,
    _difference_root_sub_iter,
    difference_root_sub_lpm,
    _difference_root_sub_lpm,
    check_iter,
    check_lpm
);
sub_root!(
    difference_sub_root_iter,
    _difference_sub_root_iter,
    difference_sub_root_lpm,
    _difference_sub_root_lpm,
    check_iter,
    check_lpm
);
sub_sub!(
    difference_sub_sub_iter,
    _difference_sub_sub_iter,
    difference_sub_sub_lpm,
    _difference_sub_sub_lpm,
    check_iter,
    check_lpm
);

root_root!(
    difference_mut_root_root_iter,
    _difference_mut_root_root_iter,
    difference_mut_root_root_lpm,
    _difference_mut_root_root_lpm,
    check_iter_mut,
    check_lpm_mut
);
root_sub!(
    difference_mut_root_sub_iter,
    _difference_mut_root_sub_iter,
    difference_mut_root_sub_lpm,
    _difference_mut_root_sub_lpm,
    check_iter_mut,
    check_lpm_mut
);
sub_root!(
    difference_mut_sub_root_iter,
    _difference_mut_sub_root_iter,
    difference_mut_sub_root_lpm,
    _difference_mut_sub_root_lpm,
    check_iter_mut,
    check_lpm_mut
);
sub_sub!(
    difference_mut_sub_sub_iter,
    _difference_mut_sub_sub_iter,
    difference_mut_sub_sub_lpm,
    _difference_mut_sub_sub_lpm,
    check_iter_mut,
    check_lpm_mut
);
