...
`20260511-initial-state-peer-193.0.0.56AS3333.parquet`: The prefixes seen by a specific peer on 11-5-2026 at midnight.
`20260511-mutations-peer-193.0.0.56AS3333.parquet`: The prefix and operation (A/W) for all BGP updates/withdraws seen by a specific peer.

It is a multi-protocol BGP session. Only IPv4 prefixes are selected.
