...
The library [`ip_network_table-deps-treebitmap`](https://crates.io/crates/ip_network_table-deps-treebitmap) provides the same data structure (in the following called `TreeBitMap`) and uses a similar algorithm.
